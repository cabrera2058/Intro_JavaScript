...
const miembrosFamilia = ["Javier","Lidia","Juan","Leonidad","Santa","Lidia","Reainado","Pedro"];

//3. Crea un objeto llamado datosPersonales y que contenga la siguiente información: 
let datosPersonales = {
    nombreCompleto: "Pedro Cabrera Lopez",
    fechaNacimiento: "20/04/1997",
    lugarNacimiento: "Santiago",
    edad: 23,
    comidasFavoritas: ["Pizza","Pollo Frito","Tacos","sancocho"],
    paisesPorVisitar: ["Suiza","Estados Unidos","Japon","cuba","Inglaterra"],
...
//5. Imprime la siguiente información por la consola:
    ...
    console.log("El primer pais que me gustaria visitar es: "+datosPersonales.paisesPorVisitar[0]);
    ...
    console.log("yo nací un "+diasSemana[5]);